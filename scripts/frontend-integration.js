 ...
 * This file demonstrates how to integrate Dappwane with a web frontend
 */

// For React/Vue/Angular applications
export class DappwaneClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new DappwaneClient(provider, contractAddress);
